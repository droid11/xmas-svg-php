...
<div class="l-container home">
  <div class="illust-container">
    <div class="illust-level illust-level--intro">
      ...
      <div class="illustItem illustItem--holly symbol symbol--holly">
        <img src="./svg/holly.svg" alt="Holly">
      </div>
      ...
      <div class="illustItem illustItem--ivy symbol symbol--ivy">
        <img src="./svg/ivy.svg" alt="Ivy">
      </div>
    </div>
  </div>
  <div class="illust-level--town">
    <div class="illustItem illustItem--snowglobe">
      <img src="./svg/snowglobe.svg" alt="Snow Globe">
    </div>
    <div class="illustItem illustItem--town">
      <img class="svg-town" src="./svg/town.svg" alt="Town">
      <div class="svg-house">
        <img src="./svg/house.svg" alt="House">
        <img class="svg-lights" src="./svg/lights.svg" alt="lights">
      </div>
      <img class="svg-sleigh" src="./svg/sleigh.svg" alt="Sleigh">
      <div class="svg-star inactive">
        <img src="./svg/star.svg" alt="Star">
      </div>
      <img class="svg-sledge" src="./svg/sledge.svg" alt="sledge">
      <img class="svg-robins" src="./svg/robins.svg" alt="robins">
      <img class="svg-peace" src="./svg/peace.svg" alt="peace">
      <img class="svg-shopping" src="./svg/shopping.svg" alt="shopping">
      <div class="svg-carollers">
        <img src="./svg/carolers.svg" alt="carollers">
      </div>
  ...
  <footer class="page-footer">
    <ul class="unstyled page-footer-links">
      <li><a class="page-footer-info" href="" target="_blank"></a></li>
    </ul>
  </footer>
</div>
<!-- partial -->
